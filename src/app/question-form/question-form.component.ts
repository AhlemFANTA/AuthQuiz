...
export class QuestionFormComponent implements OnInit {
  ...
  onSingleSelection() {
    this.question.choices.forEach(c => c.selected = false);
    this.selectedChoice.selected = true;
    
    console.log("CHANGED::: ", this.selectedChoice);
    this.onChoiceMade.emit(this.selectedChoice);
  }

  onMultipleSelections() {
    console.log("CHANGEDXXXX::: ", this.question.choices);
